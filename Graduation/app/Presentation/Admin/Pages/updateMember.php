...
<body>
    ...
    <section class="cover">
        <div class="page-wrapper">
            ...
            <div class="form-card">
                <form action="updateMember_logic.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <input type="hidden" name="old_image" value="<?php echo htmlspecialchars($row['image']); ?>">

                    <div class="current-image">
                        <img src="uploadsTeamPhotos/<?php echo htmlspecialchars($row['image']); ?>" alt="member">
                    </div>
