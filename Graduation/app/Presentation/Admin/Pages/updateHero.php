...
<body class="be-light">
    ...
    <section class="cover">
        <div class="page-wrapper">
            ...
            <div class="form-card">
                <form action="updateHero_logic.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="current-image-box">
                                <img src="uploadsStoriesPhoto/<?php echo htmlspecialchars($row['image']); ?>"
                                    alt="current image">
                            </div>
                        </div>
                    ...
                    <div class="actions">
                        ...
                        <a href="storyPersons.php?story_id=<?php echo $story_id; ?>" class="btn-cancel">
                            إلغاء
                        </a>
                    </div>
                </form>
