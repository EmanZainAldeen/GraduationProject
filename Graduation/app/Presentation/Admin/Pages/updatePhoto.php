...
<body class="bg-light">
    ...
    <section class="cover">
        <div class="page-wrapper">
            ...
            <div class="form-card">
                <form action="updatePhoto_logic.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="current-image-box">
                                <img src="uploadsPhotos/<?php echo htmlspecialchars($row['image']); ?>" width="100">
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="actions">
                        ...
                        <a href="adminPhotoPage.php" class="btn-cansel">الغاءالتحديث</a>
                    </div>
                </form>
            </div>
        </div>
